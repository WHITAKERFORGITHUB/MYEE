...
public class RepBoardDAOOracle implements RepBoardDAO {
	...
	public void insert(RepBoard board) throws AddException{
		...
		String insesrtSQL = "INSERT INTO repboard(board_no, parent_no, board_title, board_writer, board_dt, board_pwd, board_cnt) VALUES (board_seq.NEXTVAL, ?,?,?,SYSDATE,?,0)";
		
		try {
			pstmt = con.prepareStatement(insesrtSQL);
